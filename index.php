...
<body>
    <header class="p-2">
        ...
        <div class="my-nav">
            <ul class="d-flex list-unstyled">
                <li><a class="text-decoration-none p-2" href="#">Introduzione</a></li>
                <li><a class="text-decoration-none p-2" href="#">Norme sulla Privacy</a></li>
                <li><a class="text-decoration-none p-2" href="#">Termini di servizio</a></li>
                <li><a class="text-decoration-none p-2" href="#">Tecnologie</a></li>
                <li><a class="text-decoration-none p-2" href="#">Domande frequenti</a></li>
            </ul>
        </div>
    ...
    <main>
        <div class="container">
            <?php
              foreach ($db as $key => $section) {
                $paragrafi = $section["paragrafi"]
            ?>
            <section class="py-3">
                <h2 class="pt-5"><?php echo $section["titolo"]?> </h2>
                <?php
                    foreach($paragrafi as $paragrafo){
                ?>
                <div class="pt-4"><?php echo $paragrafo?></div>
                <?php } ?>
                <?php if ($section["sottotitolo"]) { ?>
